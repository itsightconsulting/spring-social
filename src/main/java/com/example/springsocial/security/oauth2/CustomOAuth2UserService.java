...
import com.example.springsocial.model.SecurityRole;
import com.example.springsocial.model.SecurityUser;
import com.example.springsocial.model.User;
import com.example.springsocial.repository.SecurityUserRepository;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        boolean secUserExists = securityUserRepository.findUsernameExists(oAuth2UserInfo.getEmail()) != null;
        User user;

        if(secUserExists && userOptional.isPresent()){
